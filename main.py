...
bot = TeleBot(token)
hideBoard = types.ReplyKeyboardRemove(one_time_keyboard=True)
...
Помогу тебе сохранить твои проекты и информацию о них! ^_^) 
""")
    info(message)
...
def info(message):
    bot.send_message(message.chat.id,
                     ...
                     /info - чтобы получить этот текст еще раз
...
# даем статус боту ыххыыххыхыхыхых
...
# выбор своих уменийт пример работать в поле лучше чем шоколадный мальчик)))))))))
...
# установление скила для своего раба электроного
...
# посмотреть своих чернокожих пупсиков❤️
...
# прокачка водителя Ашота Ваншота
...
# второй шаг обновление машины на миньона
...
# обновление своей команды а именно сеньора жава дебила
...
# команда что бы сделать print("my niger boy")
